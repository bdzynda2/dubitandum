...
We want to show this is true for the $k+1$ step, or the inductive step:


$$(B_1 \setminus \{b_1,..., b_k, b_{k+1}\}) \cup \{b_{M+1}, ..., b_{m+k}\} \cup \{b_{m+k+1}\} \succsim_t (B_1 \setminus \{b_1,..., b_k, b_{k+1}\}) \cup \{b_{M+1}, ..., b_{m+k}\} \cup b_{k+1}$$
