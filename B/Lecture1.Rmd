...
Where $|T| \ne |B|$ in all cases. Consider an agent $i \in T \cup B$.  This agent is in either one side of the market or the other. That is $I \in \{T, B\}$ $J$ will be on the other side of the market. So, $J \in \{T, B\} \setminus \{I\}$
